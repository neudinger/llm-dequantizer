...
By keeping the data compressed until it hits the CPU registers (Kernel Fusion), you drastically reduce the stress on the RAM, which is the primary limiter for LLM speed.